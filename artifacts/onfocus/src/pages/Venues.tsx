    ...
    <div className="min-h-screen bg-background pt-32 pb-24">
      <div className="container mx-auto px-6 md:px-8">
        <div className="mb-16 border-b border-border pb-12">
          <h1 className="text-5xl md:text-6xl font-bold tracking-tight mb-6 text-foreground" data-testid="text-venues-heading">Venues</h1>
          <p className="text-xl text-muted-foreground max-w-2xl leading-relaxed" data-testid="text-venues-subheading">
            Find the perfect setting for your unforgettable moments.
          </p>
        </div>
